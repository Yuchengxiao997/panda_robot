...
class PointToPoint(gym.Env):
    ...
    def reset(self):
        ...
        x = (self.np_random.uniform(5, 9) if self.np_random.randint(2) else self.np_random.uniform(-9,-5))

        y = (self.np_random.uniform(5, 9) if self.np_random.randint(2) else self.np_random.uniform(-9,-5))
