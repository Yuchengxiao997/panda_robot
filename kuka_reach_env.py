...
class KukaReachEnv(gym.Env):
    ...
    def _reward(self):
        ...
        self.robot_state_orientation = p.getLinkState(self.kuka_id, self.num_joints - 1)[5]
        print("top center position:",self.robot_state,self.robot_state_orientation)
        self.robot_state0 = p.getLinkState(self.kuka_id, 0)[4]
        self.robot_state1 = p.getLinkState(self.kuka_id, 1)[4]
        self.robot_state2 = p.getLinkState(self.kuka_id, 2)[4]
        self.robot_state3 = p.getLinkState(self.kuka_id, 3)[4]
        self.robot_state4 = p.getLinkState(self.kuka_id, 4)[4]
        self.robot_state5 = p.getLinkState(self.kuka_id, 5)[4]
        print('关节0',self.robot_state0)
        print('关节1', self.robot_state1)
        print('关节2', self.robot_state2)
        print('关节3', self.robot_state3)
        print('关节4', self.robot_state4)
        print('关节5', self.robot_state5)
        print('关节6', self.robot_state)
        ...
        info = dict(distance =self.distance )
