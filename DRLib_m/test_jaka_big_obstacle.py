...
def produce_position(base_position):
    ...
    position.append([0.7,0.2,0.1])
    position.append([0.7,0.2,0.12])
    position.append([0.7, 0.2, 0.14])
    position.append([0.7, 0.2, 0.16])
    position.append([0.7, 0.2, 0.18])
    position.append([0.7, 0.2, 0.2])
    return position
def ring():
