...
from test_jaka_cube import KukaReachEnv
"""
        ...
        for c in range(args.n_cycles):
            ...
            for j in range(args.n_steps):
                ...
                try:
                    ...
                    print('begin->>>',env.current_pos,env.object_pos)
                    ...
                    if info["is_success"]==1:
                        ...
                        re_midle = []
                        re_midle.append(-midle[0])
                        re_midle.append(-midle[1])
                        re_midle.append(-midle[2])
                        print('re_midle',re_midle)
