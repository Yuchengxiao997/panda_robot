...
try:
    ...
    import sys
    sys.path.insert(0,join("/home/yuchengxiao/下载/ompl-1.5.2/py-bindings"))
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    print(sys.path)
    from ompl import util as ou
    from ompl import base as ob
...
class PbOMPL():
    def __init__(self, robot, obstacles = []) -> None:
        ...
        joint_bounds = [[-2.8973, 2.8973], [-2.8973, 2.8973], [-2.8973, 2.8973],  [-2.8973, 2.8973], [-2.8973, 2.8973], [-2.8973, 2.8973]]
