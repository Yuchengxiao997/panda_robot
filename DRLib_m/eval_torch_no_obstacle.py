...
from test_jaka_usejoint import KukaReachEnv
...
def launch(net, args):
    ...
    net.ac.load_state_dict(torch.load('goal_with_joint_free/actor_328.pth'))
    net.load_norm("goal_with_joint_free/norm_328.pkl")
